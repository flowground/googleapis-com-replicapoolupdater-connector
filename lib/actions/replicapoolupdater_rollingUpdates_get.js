 ...
 *
 *
 * Operation: 'replicapoolupdater.rollingUpdates.get'
 * Endpoint Path: '/{project}/zones/{zone}/rollingUpdates/{rollingUpdate}'
 * Method: 'get'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/{project}/zones/{zone}/rollingUpdates/{rollingUpdate}',
        method: 'get',
