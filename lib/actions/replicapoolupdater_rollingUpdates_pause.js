 ...
 *
 *
 * Operation: 'replicapoolupdater.rollingUpdates.pause'
 * Endpoint Path: '/{project}/zones/{zone}/rollingUpdates/{rollingUpdate}/pause'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/{project}/zones/{zone}/rollingUpdates/{rollingUpdate}/pause',
        method: 'post',
